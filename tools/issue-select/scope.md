...
I am most comfortable with Python, Java, JavaScript, SQL, REST APIs, Git, and backend development, and I have also worked with tools such as FastAPI, Docker, MySQL, and Neo4j. I would like to get better at navigating unfamiliar codebases, debugging, testing, and contributing through the open-source workflow. For my first contribution, I prefer a focused issue with clear expected behavior and would rather avoid changes that require deep knowledge of complex internals or a very large codebase.